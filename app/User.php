...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract
{
     ...
     * @var array
     */
    protected $fillable = ['user_id','email', 'password','username','sponsor','rank_id','register_by','name','lastname','transaction_pass','hypperwalletid','hypperwallet_token','created_at'];
   ...
   public static function upadteUserBalance($user_id,$sponsor_commisions){
    ...
    public static function add($data,$sponsor_id,$placement_id){
            ...
            Transactions::sponsorcommission($sponsor_id,$userresult->id,$data['package']);
            // $sponsor_id
            // LeadershipBonus::allocateCommission($sponsor_id,Sponsortree::where('user_id',$sponsor_id)->value('sponsor'),$userPackage->pv / 10);

            LeadershipBonus::allocateCommission($userresult->id,$sponsor_id,$data['package']);
