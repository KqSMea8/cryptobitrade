            ...
            <div class="col-lg-12">
                <div id="" class="input-group view-state panel-title">
                  ...
                  <label>
                    ...
                    <button data-action="reloads" type="button" id="btn-restart-genealogy-node" class="btn btn-default btn-ladda btn-ladda-spinner" data-style="expand-left" data-spinner-color="#333" data-spinner-size="20"><span class="ladda-label"><i class="icon-spinner4 position-left"></i>Reset Tree</span></button>
                    </span>
                </div>
            </div>
        </div>
