...
<div class="required form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
    {!! Form::label('lastname', trans("all.last_name"), array('class' => 'control-label')) !!} {!! Form::text('lastname', Input::old('lastname'), ['class' => 'form-control','required' => 'required','data-parsley-required-message' => trans("all.please_enter_last_name"),'data-parsley-group' => 'block-1']) !!}
    <span class="help-block">
...
<div class="col-lg-9 ">
 <div class="card-body">
  <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
            <li class="nav-item active"><a href="#steps-bankpayout-tab1" class="nav-link  steps-leadership active  " data-toggle="tab" data-payment='newregiserd'> {{ trans("all.payout_info") }}</a>
            </li>
            <li class="nav-item"><a href="#steps-hypperwallet-tab2" class="nav-link steps-plan-payment" data-toggle="tab" data-payment='BinaryMatchBonus'>{{ trans("all.hypperwallet") }}</a></li>
            
        </ul>


 <div class="tab-content" style="height: 300px">
    <div class="tab-pane active  " id="steps-bankpayout-tab1"> 
          <div class="panel-body">
                  <div class="form-group">
<div class="row">
<!-- begin col-6 -->
...
<div class="required form-group has-feedbackX has-feedback-leftx {{ $errors->has('account_number') ? ' has-error' : '' }}">
    ...
    <span class="help-block">
        <small>{!! trans("all.please_enter_account_number") !!}</small>
...
<div class="required form-group has-feedbackX has-feedback-leftx {{ $errors->has('account_number') ? ' has-error' : '' }}">
    ...
    <span class="help-block">
        <small>{!! trans("all.please_enter_account_holder_name") !!}</small>
...
<div class="required form-group has-feedbackX has-feedback-leftx {{ $errors->has('account_number') ? ' has-error' : '' }}">
  ...
  <div class="text-right">
       ...
       <div class="tab-pane   " id="steps-hypperwallet-tab2">
               <div class="panel-body">

@if($selecteduser->hypperwalletid!=null)
    <div class="form-group">
        <div class="row">
            <div class="col-md-6">
                <label>
                ...
                <input class="form-control" name="hypperwalletid" readonly="" type="text" value="{{ $selecteduser->hypperwalletid }}">
...
@else
   ...
   Please Create Hypperwallet ID 

 
<br>    

<div>
  <a href="{{ URL::to('user/createhypperwalletid/'.$selecteduser->id) }}" type="button" class="btn btn-primary">createID</a>
