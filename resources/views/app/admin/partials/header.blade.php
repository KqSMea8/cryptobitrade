    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{ URL::to('/home') }}">
                <img src="{{ url('img/cache/original/'.$logo)}}" class="inpagelogo-small" alt="{{ config('app.name', 'Cloud MLM Software') }}">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                     @if(Auth::user()->id==1)
                        <li><a href="{{url('admin/userprofiles/'.Auth::user()->username)}}"><i class="icon-user-plus"></i>{{trans('all.my_profile')}}</a></li>
