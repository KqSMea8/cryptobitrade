                            ...
                            <div class="col-xs-12 ">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
                                    <div class="list-group">
                                        ...
                                        <a href="#" payment="stripe" class="list-group-item text-center active" class="">
                                            Stripe
                                            <br/> 
                                        </a> 
                                        <a href="#" payment="paypal" class="list-group-item text-center" class="">
                                          ...
                                          <a href="#" payment="authorize" class="list-group-item text-center" class="">
                                             Athorize .net
                                            <br/> 
                                        </a>
                                         <a href="#" payment="skrill" class="list-group-item text-center" class="">
                                             Skrill 
                                            <br/> 
                                        </a>
                                    ...
                                    <div class="bhoechie-tab-content active">
                                        <div class="text-center">
                                            <div class="text-center"> 
                                                ...
                                                <p>
                                                    <!-- <button class="btn btn-success btn-lg" role="button">Cheque payment confirmation</button> -->
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bhoechie-tab-content">
                                        <div class="text-center">
                                            <div class="text-center">                                                   
                                                ...
                                                <p>
                                                    <button class="btn btn-success btn-lg" role="button">{{trans('register.confirm_registration') }}</button>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bhoechie-tab-content">
                                                <button class="btn btn-success btn-lg" role="button"><img src="https://www.skrill.com/fileadmin/content/images/brand_centre/Skrill_Logos/skrill-150x65_en.gif" alt="Skrill banner 150x65" title="Use the Skrill Digital Wallet for all your online transactions."></button>
                                        </div>
