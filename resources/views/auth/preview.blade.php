...
<div class="alert bg-success alert-styled-left">
    ...
    <span class="text-semibold">Registration Completed!</span> You have successfully registered <strong>{{$userresult->username}} ({{$userresult->name}} {{$userresult->lastname}})</strong> in <strong>{{($userresult->tree_table->leg==='l'? 'Left' : 'Right' )}} leg</strong> under sponsor, <strong>{{$sponsorUserName}}</strong>. Payment done via <strong>{{$userresult->register_by}}.</strong>
</div>
<div class="panel">
